...
//                String result = alipay.pay(payInfo, true);
     ...
     */
    private String getOrderInfo(PayInfoBean payBean) {
        Util.pLog("num:" + getOutTradeNo() + " name:" + payBean.getPayName() + " info:" + payBean.getPayIntro() + " price:" + payBean.getPayPrice());
        // 签约合作者身份ID
        String orderInfo = "partner=" + "\"" + PARTNER + "\"";
        // 签约卖家支付宝账号
        orderInfo += "&seller_id=" + "\"" + SELLER + "\"";
        // 商户网站唯一订单号
        orderInfo += "&out_trade_no=" + "\"" + payBean.getPayOutTradeNum() + "\"";
        // 商品名称
        orderInfo += "&subject=" + "\"" + payBean.getPayName() + "\"";
        // 商品详情
        orderInfo += "&body=" + "\"" + payBean.getPayIntro() + "\"";
        // 商品金额
        orderInfo += "&total_fee=" + "\"" + payBean.getPayPrice() + "\"";
        // 服务器异步通知页面路径
